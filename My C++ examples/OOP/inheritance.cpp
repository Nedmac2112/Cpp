...
// Decription: This program demonstrates inheritance in C++ using a Food class and a Pizza class that inherits from the Food class. The Food class has private data members name and calories, and public member functions to set and get the values of the private data members. The Pizza class inherits from the Food class and has additional private data members diameter, slices, and meat, and public member functions to set and get the values of the private data members. The program creates objects of the Food and Pizza classes using both default and parameterized constructors and prints the values of the private data members to the console.
